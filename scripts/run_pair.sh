...
./train_network_pair.py /orion/group/ShapeNetManifold_10000/03001627/ myruns/chair/ --use_sq --lr 1e-4 --n_primitives 20 --train_with_bernoulli --dataset_type shapenet_v2 --use_chamfer --run_on_gpu
